...
public static class SpecificationBuilderExtensions
{
        ...
        Search? search) where T : class
    {
        ...
        return specificationBuilder; //in 9.0.1 
    }
        ...
        ParameterExpression parameter)
    {
        ...
        var valueExpresion = GeValueExpression(field, value, propertyExpression.Type);
        return CreateFilterExpression(propertyExpression, valueExpresion, filterOperator);
    }
