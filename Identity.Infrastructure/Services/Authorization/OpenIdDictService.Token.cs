...
public partial class OpenIdDictService
{
    ...
    public  async Task<IResult> ExchangeAsync(HttpContext httpContext)
    {
        ...
        {
            return await HandleExchangeAuthorizationAndDeviceCodeAndRefreshTokenReGrantType(httpContext, request);
        }

        throw new NotImplementedException("The specified grant type is not supported.");
    }
    
    private async Task<IResult> HandleExchangeAuthorizationAndDeviceCodeAndRefreshTokenReGrantType(HttpContext httpContext, OpenIddictRequest request)
    {
    ...
    private async Task<IResult> HandleExchangePasswordGrantType( OpenIddictRequest request)
    {
        ...
        if (user is null)
        {
            ...
            return Results.Forbid( properties: properties, authenticationSchemes: new List<string>
            {
                OpenIddictServerAspNetCoreDefaults.AuthenticationScheme
            });
        }
